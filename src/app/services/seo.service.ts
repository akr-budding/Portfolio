...
export class SeoService {
  ...
  public update(meta: PageMeta) {
    ...
    this.meta.updateTag({ property: 'og:image', content: meta.image ?? '/assets/og-cover.svg' });
    ...
    this.meta.updateTag({ name: 'twitter:image', content: meta.image ?? '/assets/og-cover.svg' });
  }
}
